...
export const secrets: Secret[] = [
    ...
    },
    {
        ...
        description:
            'Она находится в разделе "Перечень сыщиков лицея". Нужно было заметить красную надпись на вопросе "Тебе пять от вопроса!" Эту идею подкинул кто то из учеников, честно, не помню, кто это был',

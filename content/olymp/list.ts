...
// Поля
// - href  (string):    Ссылка на сайт (страницу) олимпиады.
// - title (string):    Название олимпиады.
// - type  (string?):   Тип олимпиады
//                      ('Олимпиада', 'Конкурс', 'Перечневая олимпиада', ...)
// - level (string?):   Уровень олимпиады
//                      ('Муниципальный', 'Городской', 'Всероссийский', 'Международный', ...)
// - place (string?):   Место проведения олимпиады.
// - date  (string?):   Дата проведения олимпиады.
...
export const otherOlympiads: Olymp[] = [
    ...
    {
        title: 'Открытая региональная олимпиада школьников по информатике для 6-8 классов',
        href: 'https://olymp.academtalant.ru/reginf',
        type: 'Олимпиада',
        level: 'Городской',
    },
]
